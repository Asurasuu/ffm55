...
<head>
    ...
    <title>Омская Федерация Функционального Многоборья - Добавление новости</title>
...
<body>
    ...
    <div class="add_container">
        ...
        <div class="links"><a href="adm_news.php">Назад</a></div>
        <form enctype="multipart/form-data" method="post" action="./scripts/add_new.php" id="form_editor">
            <div>
            ...
            <div>
                <textarea name="text" name="text" placeholder="Тут текст" id="editor"></textarea>
            </div>
            <div>
                <input type="submit" name="add_new" value="Сохранить" id="save">
            </div>
        </form>
    </div>
